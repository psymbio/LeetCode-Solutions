public class arraySearch2 {
    public static void main(String args[]) {
        ...
        System.out.println("Does the array contain the element 4? - " + arraySearch2.linearSearch(array, length, 4));
        System.out.println("Does the array contain the element 30? - " + arraySearch2.linearSearch(array, length, 30));
